...
import { useAddSaving } from '../hooks/useSavings.js'
import { TransactionType } from '../types/savings.js'
import { BaseModalProps } from '../types/ui.js'
import { CURRENCIES, DEFAULT_CURRENCY, Currency } from '../constants/currencies.js'
import { TRANSACTION_TYPES, DEFAULT_TRANSACTION_TYPE } from '../constants/transactions.js'

type AddSavingModalProps = BaseModalProps

export default function AddSavingModal({ isOpen, onClose }: AddSavingModalProps) {
                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:ml-0 sm:mt-0 sm:text-left w-full">
                    <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-900">
                      {transactionType === 'deposit' ? 'Додати заощадження' : 'Зняти гроші'}
                    </Dialog.Title>
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                      ...
                      <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                        ...
                        >
                          {addSaving.isPending ? 'Збереження...' : 'Зберегти'}
                        </button>
                        <button
                          type="button"
