...
export default function PWAPrompt() {
  ...
  return (
    <>
      {/* Install Prompt */}
      <Transition.Root show={isInstallable} as={Fragment}>
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Встановіть Kapusta на свій пристрій для швидкого доступу і роботи офлайн.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      {/* Update Prompt */}
      <Transition.Root show={needRefresh} as={Fragment}>
        <Dialog as="div" className="relative z-50" onClose={() => {}}>
          <div className="fixed bottom-4 right-4 w-80">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white shadow-xl ring-1 ring-black ring-opacity-5">
                <div className="p-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 w-0 flex-1">
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        Нова версія додатку готова для встановлення.
                      </p>
          ...
          <div className="rounded-lg bg-green-50 p-4 shadow-lg ring-1 ring-green-200">
            <div className="flex">
              ...
              <div className="ml-auto pl-3">
                <button
                  type="button"
                  className="inline-flex rounded-md bg-green-50 text-green-500 hover:text-green-600"
                  onClick={closeUpdatePrompt}
                >
                  <XMarkIcon className="h-5 w-5" />
                </button>
